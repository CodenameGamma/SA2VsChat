...
namespace CrowdControl
{
    public class SimpleTCPClient : IDisposable
    {
        ...
        public static void StartThreadingCC()
        {
            CrowdControl.SimpleTCPClient simpleTCPClient = new CrowdControl.SimpleTCPClient();
            CrowdControl.Example Example = new CrowdControl.Example();
        ...
        public SimpleTCPClient()
        {
            ...
            Console.WriteLine("Crowd Control Game Started!");
        }
        ...
        private async void Listen()
        {
            ...
            while (!_quitting.IsCancellationRequested)
            {
                try
                {
                    ...
                    _ready.Wait(_quitting.Token);

                    if (_quitting.IsCancellationRequested) { return; }
